  ...
  return (
    <div className="db-chart-box">
      <div className="db-chart-header">
        ...
        <div className="db-spending-legend" aria-label="Chart legend">
          <span className="db-legend-pill db-legend-pill--actual">
            <span className="db-legend-dot" style={{ background: "#2DD4BF" }} aria-hidden="true" />
            Actual
          </span>
          <span className="db-legend-pill db-legend-pill--predicted">
            <span className="db-legend-dot" style={{ background: "#6366F1" }} aria-hidden="true" />
            Predicted
          </span>
        </div>
      </div>
      ...
      {/* SVG Chart */}
      <div className="db-line-chart-wrap" role="img" aria-label="Line chart showing actual vs predicted spending over 6 months">
      ...
      {/* Summary row */}
      <div className="db-chart-summary" aria-label="Chart summary statistics">
        <div className="db-chart-summary-item">
          <span className="db-chart-summary-dot" style={{ background: "#2DD4BF" }} aria-hidden="true" />
          <span className="db-chart-summary-label">Avg Actual</span>
          <span className="db-chart-summary-val">₱60,167</span>
        </div>
        <div className="db-chart-summary-divider" aria-hidden="true" />
        <div className="db-chart-summary-item">
          <span className="db-chart-summary-dot" style={{ background: "#6366F1" }} aria-hidden="true" />
          <span className="db-chart-summary-label">Avg Predicted</span>
          <span className="db-chart-summary-val">₱59,333</span>
        </div>
        <div className="db-chart-summary-divider" aria-hidden="true" />
        <div className="db-chart-summary-item">
          <span className="db-chart-summary-dot" style={{ background: "#F59E0B" }} aria-hidden="true" />
